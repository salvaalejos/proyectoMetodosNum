 ...
 * @author hfyh
 */
public class MetodoPosicion extends javax.swing.JFrame {
    ...
    public MetodoPosicion() {
        initComponents();
    }
    
    public MetodoPosicion(String funcion) {
        this.funcion = funcion;
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Metodo de falsa posición");
    }
    ...
    public void graficarFuncion(String funcion, double a, double b, JPanel panel) {
        ...
        panelLimitsLayout.setHorizontalGroup(
            ...
            .addGroup(panelLimitsLayout.createSequentialGroup()
                ...
                .addGroup(panelLimitsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(fieldTolerancy, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
                    .addComponent(fieldLimitA, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE))
                .addContainerGap())
    ...
    private void iterar(JTable tabla){
        ...
        List<String> iteraciones = falsaPosicion(funcion, a, b, tol, series);
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        new ObtenerFuncion(4).setVisible(true);
        clearAll();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MetodoPosicion().setVisible(true);
            }
        });
    }
