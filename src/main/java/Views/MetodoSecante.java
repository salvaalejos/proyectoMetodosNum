...
public class MetodoSecante extends javax.swing.JFrame {
    ...
    public MetodoSecante(String funcion) {
        this.funcion = funcion;
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Metodo de secante");
    }
    ...
    private void initComponents() {
        ...
        panelLimitsLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelLimitsLayout.createSequentialGroup()
    ...
    private void iterar(JTable tabla){
        ...
        List<String> iteraciones = secante(funcion, a, b, tol, series);
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        new ObtenerFuncion(2).setVisible(true);
        clearAll();
        dispose();
